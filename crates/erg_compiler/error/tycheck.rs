    ...
    pub fn argument_error(
        ...
        Self::new(
            ErrorCore::new(
                ...
                switch_lang!(
                    "japanese" => "ポジショナル引数の数が違います".to_string(),
                    "simplified_chinese" => "正则参数的数量不匹配".to_string(),
                    "traditional_chinese" => "正則參數的數量不匹配".to_string(),
                    "english" => "the number of positional arguments is mismatched".to_string(),
                ),
                errno,
                TypeError,
                loc,
    ...
    pub fn param_error(
        ...
        Self::new(
            ErrorCore::new(
                ...
                switch_lang!(
                    "japanese" => "引数の数が違います".to_string(),
                    "simplified_chinese" => "参数的数量不匹配".to_string(),
                    "traditional_chinese" => "參數的數量不匹配".to_string(),
                    "english" => "the number of parameters is mismatched".to_string(),
                ),
                errno,
                TypeError,
                loc,
    ...
    pub fn unification_error(
        ...
        Self::new(
            ErrorCore::new(
                ...
                switch_lang!(
                    "japanese" => "型の単一化に失敗しました".to_string(),
                    "simplified_chinese" => "类型统一失败".to_string(),
                    "traditional_chinese" => "類型統一失敗".to_string(),
                    "english" => "unification failed".to_string(),
                ),
                errno,
                TypeError,
                loc,
    ...
    pub fn re_unification_error(
        ...
        Self::new(
            ErrorCore::new(
                ...
                switch_lang!(
                    "japanese" => "型の再単一化に失敗しました".to_string(),
                    "simplified_chinese" => "重新统一类型失败".to_string(),
                    "traditional_chinese" => "重新統一類型失敗".to_string(),
                    "english" => "re-unification failed".to_string(),
                ),
                errno,
                TypeError,
                loc,
    ...
    pub fn subtyping_error(
        ...
        Self::new(
            ErrorCore::new(
                ...
                switch_lang!(
                    "japanese" => "この式の部分型制約を満たせません".to_string(),
                    "simplified_chinese" => "无法满足此表达式中的子类型约束".to_string(),
                    "traditional_chinese" => "無法滿足此表達式中的子類型約束".to_string(),
                    "english" => "the subtype constraint in this expression cannot be satisfied".to_string(),
                ),
                errno,
                TypeError,
                loc,
    ...
    pub fn pred_unification_error(
        ...
        Self::new(
            ErrorCore::new(
                ...
                switch_lang!(
                    "japanese" => "述語式の単一化に失敗しました".to_string(),
                    "simplified_chinese" => "无法统一谓词表达式".to_string(),
                    "traditional_chinese" => "無法統一謂詞表達式".to_string(),
                    "english" => "predicate unification failed".to_string(),
                ),
                errno,
                TypeError,
                loc,
    ...
    pub fn self_type_error(input: Input, errno: usize, loc: Location, caused_by: String) -> Self {
        Self::new(
            ErrorCore::new(
                vec![SubMessage::only_loc(loc)],
                switch_lang!(
                    "japanese" => "`Self`型はこの場所では使えません".to_string(),
                    "simplified_chinese" => "`Self`类型不能用于此处".to_string(),
                    "traditional_chinese" => "`Self`類型不能用於此處".to_string(),
                    "english" => "`Self` type cannot be used here".to_string(),
                ),
                errno,
                TypeError,
                loc,
